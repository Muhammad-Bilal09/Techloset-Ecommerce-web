    ...
    <div className="w-full lg:h-[394px] grid lg:grid-cols-2 gap-4 px-4 lg:px-0">
      ...
      <div className="flex flex-col justify-center items-center lg:items-start ml-0 lg:ml-[173px] mr-0 lg:mr-[108px] order-2 lg:order-1 text-center lg:text-left">
        ...
        <div className="mt-4 flex flex-col lg:flex-row items-center lg:items-start">
          <button className="my-2 lg:my-4 w-[327px] mx-0 lg:mx-6 bg-orange lg:w-36 h-[50px] lg:h-[61px] rounded-3xl text-white font-heading">
            Shop now
          </button>
          <button className="my-2 lg:my-4 mx-0 lg:mx-6 border-primary border text-primary w-full lg:w-36 h-[50px] lg:h-[61px] rounded-3xl font-heading">
            View more
          </button>
        </div>
...
//       <div className="relative flex justify-center items-center lg:order-2 lg:mr-44  order-1">
//         <img
//           className="my-[22px] w-[289px] h-auto"
//           src={images[currentIndex]}
//           alt={`Camera ${currentIndex + 1}`}
//         />
//         <div className="ml-1 absolute left-80 bottom-11 lg:left-80 lg:bottom-12 md:left-[390px] md:bottom-[35px] rounded-[588.94px] md:w-[104.83px] md:h-[100.12px] sm:w-[99.83px] sm:h-[95.12px] w-[90.81px] h-[86.10px] bg-orange">
//           <div className="text-[15px] sm:text-[21.57px] top-6 relative leading-12 text-white text-center items-center justify-center font-semibold">
//             <div>only</div>
//             <div>$89</div>
//           </div>
//         </div>
//       </div>
//       <div className="flex flex-col justify-center items-center lg:items-start ml-[173px] mr-[108px] order-2 lg:order-1">
//         <p className="font-bold flex lg:w-20 text-primary text-[43px] font-heading">
//           Canon Camera
//         </p>
//         <div className="mt-4 flex flex-col lg:flex-row">
//           <button className="my-4 mx-6  bg-orange w-[327px] lg:w-36 h-[61px] rounded-3xl text-white font-heading">
//             Shop now
//           </button>
//           <button className="my-4 mx-6  border-primary border text-primary w-[327px] lg:w-36 h-[61px] rounded-3xl font-heading">
//             View more
//           </button>
//         </div>
