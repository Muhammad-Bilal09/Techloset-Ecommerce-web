...
export default function Blog() {
  return (
    <>
      <div className="mx-4 lg:ml-14 gap-5 lg:mr-14 my-8 grid grid-cols-1 lg:grid-cols-2">
        <div className="flex flex-col lg:flex-row lg:w-[100%] lg:h-[369px] bg-white shadow-md rounded-lg border p-4 lg:p-6">
          ...
          <div className="lg:ml-6 flex-1 lg:w-[265px] lg:h-[300px] mt-4 lg:mt-0">
            ...
            <p className="text-blog lg:w-[100%] lg:h-[68px] text-lg font-extrabold  my-3 font-heading">
        ...
        <div className="flex flex-col lg:w-[100%] lg:h-[369px] lg:flex-row bg-white shadow-md rounded-lg border p-4 lg:p-6">
          <div className="flex-shrink-0">
            <img
              className="w-full lg:w-70 h-auto lg:h-72 object-cover rounded-lg"
              src={bagTwo}
