          ...
          <div className="w-full md:w-1/4 px-4 mb-10 md:mb-0">
            ...
            <nav>
              <ul>
                ...
                <li className="my-3">
                  <a className="text-primary hover:underline">Chronograph Blue</a>
                </li>
                <li className="my-3">
                  <a className="text-primary hover:underline">Smart Phone</a>
                </li>
                <li className="my-3">
                  <a className="text-primary hover:underline">Hair Straightener</a>
                </li>
              </ul>
            </nav>
          </div>
          ...
          <div className="w-full md:w-1/4 px-4 mb-10 md:mb-0">
            ...
            <nav>
              <ul>
                ...
                <li className="my-3">
                  <a className="text-primary hover:underline">Automatic Watch</a>
                </li>
                <li className="my-3">
