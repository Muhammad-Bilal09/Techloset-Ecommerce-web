      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex">
              <button
                className="flex font-semibold justify-center font-heading items-center w-40 rounded-3xl  ml-auto text-white bg-orange border-0 p-4 focus:outline-none"
              >
                Buy it Now
              </button>
              <ToastContainer />
      ...
      <div className="grid lg:grid-cols-4  lg:ml-[64px] lg:mr-[61px] mx-10">
        {state?.items.data &&
          state.items.data.slice(0, 4).map((item: ItemType) => (
            <div className="lg:w-[308px] lg:h-[313px] shadow-md rounded-[19.67px] border-5 p-5 mt-3" key={item.id}>
