import camera1 from "../../assets/8 1 (3).png";
import camera2 from "../../assets/360_F_79360425_13tH0FGR7nYTNlXWKOWtLmzk7BAikO1b.jpg";
import camera3 from "../../assets/8 1 (3).png";
      ...
      <div className="flex flex-col justify-center items-center lg:items-start ml-[109px] mr-[108px]">
        ...
        <div className="flex mt-12 lg:ml-32 space-x-2 justify-center items-center">
          <div
            ...
            className={`w-4 h-4 ${currentIndex === 0 ? 'bg-orange' : 'bg-gray'} hover:bg-orange rounded-full border border-black cursor-pointer`}
          ></div>
          <div
            onClick={() => handleDotClick(1)}
            className={`w-4 h-4 ${currentIndex === 1 ? 'bg-orange' : 'bg-gray'} hover:bg-orange rounded-full border border-black cursor-pointer`}
          ></div>
          <div
            onClick={() => handleDotClick(2)}
            className={`w-4 h-4 ${currentIndex === 2 ? 'bg-orange' : 'bg-gray'} hover:bg-orange rounded-full border border-black cursor-pointer`}
          ></div>
        </div>
      </div>
      <div className="relative flex justify-center items-center">
        <img className="w-[289px]  h-auto" src={images[currentIndex]} alt={`Camera ${currentIndex + 1}`} />
