...
import LoudSpeaker from '../../assets/11 1.png';
import Playgame2 from '../../assets/Frame 29 (3).png';
import Laptop2 from '../../assets/Frame 29 (4).png';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 p-4 lg:p-8 mt-8 lg:mt-12">
          ...
          <div className="shadow-md lg:w-[603px] rounded-3xl border-4 border-gray-200 p-4 lg:p-6 flex flex-col lg:flex-row justify-between items-center">
            ...
            <div className="flex-1 mt-4 lg:mt-0 lg:ml-4 text-center lg:text-left">
              <p className="font-bold text-blue-900 text-xl lg:text-2xl font-heading">JBL Bar 2.1 Deep Bass</p>
              <p className="mt-2 font-extrabold text-lg lg:text-xl font-heading">$11.70</p>
              ...
              <div className="flex flex-wrap justify-center lg:justify-start mt-4 space-x-2">
                {[57, 11, 33, 59].map((number, index) => (
                  <button key={index} className="rounded-full bg-blue-300 text-yellow-600 text-lg p-3 mx-1">
                    {number}
                  </button>
                ))}
              </div>
          ...
          <div className="space-y-6 lg:space-y-8">
            {[{ src: Playgame2, label: 'Play Game' }, { src: Laptop2, label: 'Laptop' }].map((product, index) => (
              <div key={index} className="shadow-md rounded-lg border-4 border-gray-200 p-4 lg:p-6 flex justify-between items-center">
                <img className="w-24 h-24 lg:w-56 lg:h-44" src={product.src} alt={product.label} />
                <div className="ml-4">
                  <p className="text-green-600 font-medium text-lg">{product.label}</p>
