      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-8 lg:ml-40">
        <div className="overflow-x-auto">
          ...
          <div className="flex justify-between mt-8">
            ...
            <button className="border-red-600 text-red-600 lg:w-40 border rounded-full font-heading p-3">
              clear cart
            </button>
          </div>
        </div>
        <div className="lg:w-[426px] h-[400px] overflow-hidden align-middle shadow-md rounded-lg border-5 p-5 ">
          ...
          <div>
            <h2 className="flex justify-between my-5">
              <span className="font-heading">Subtotal</span> ${calculateCartTotal().toFixed(2)}
            </h2>
            <hr className="my-5" />
